...
export function IntroCall() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:9000'}/api/intro-call`, {
                method: 'POST',
    ...
    const renderLeftPanel = () => (
        <div className="w-full md:w-[320px] p-6 border-b md:border-b-0 md:border-r border-slate-200 dark:border-[#1f1f1f] flex flex-col shrink-0 relative">
            ...
            <p className="text-slate-500 dark:text-[#a1a1a1] font-semibold text-sm mb-1">Rinkit Adhana</p>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-[#e1e1e1] mb-4">Intro Call</h1>

            {/* Description always visible */}
            <p className="text-slate-600 dark:text-[#a1a1a1] text-[15px] leading-relaxed mb-4">
            ...
            <p className="text-slate-600 dark:text-[#a1a1a1] mb-8 text-[15px] leading-relaxed">
                ...
                {step === 'form' ? (
                    <>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-600 dark:text-[#e1e1e1]">15m</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <MapPin className="w-5 h-5 text-slate-900 dark:text-white" />
                            <span className="text-slate-600 dark:text-[#e1e1e1]">2 location options</span>
                        </div>
                        <div className="flex items-center gap-3">
    ...
    if (step === 'success') {
        return (
            <div className="min-h-screen bg-white dark:bg-[#0B0D10] flex flex-col items-center justify-center p-4 font-sans text-slate-900 dark:text-zinc-300 transition-colors duration-300">
                <div className="max-w-md w-full bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#1f1f1f] rounded-lg shadow-sm p-8 text-center">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Meeting Scheduled!</h2>
                    <p className="text-slate-500 dark:text-[#a1a1a1] mb-8">
                    ...
                    <div className="bg-slate-50 dark:bg-[#1c1c1c] rounded-lg p-4 mb-8 text-left">
                        <p className="font-semibold text-slate-900 dark:text-white mb-1">Intro Call</p>
                        <p className="text-slate-500 dark:text-[#a1a1a1] text-sm mb-2">{getFormattedFullDate()}</p>
                        <p className="text-slate-500 dark:text-[#a1a1a1] text-sm">{selectedTimeSlot}</p>
                    </div>
                    <button
                        ...
                        <div className="flex flex-col md:flex-row h-full">
                            ...
                            <div className="flex-1 p-6 md:px-8 border-b md:border-b-0 md:border-r border-slate-200 dark:border-[#1f1f1f] pt-6 md:pt-10">
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className="text-lg text-slate-900 dark:text-white font-medium">{monthNames[currentMonth]} {currentYear}</h2>
                                ...
                                <div className="grid grid-cols-7 mb-2 text-center">
                                    {weekDays.map(day => <div key={day} className="text-[11px] font-bold text-slate-400 dark:text-[#888] tracking-wider py-2">{day}</div>)}
                                </div>
                                    ...
                                    <div className="space-y-2.5">
                                        ...
                                        {formData.location === 'Phone' && (
                                            <input
                                                ...
                                                className="w-full mt-2 bg-white dark:bg-[#111] border border-slate-300 dark:border-[#333] rounded-lg px-4 py-2.5 text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:border-slate-400 dark:focus:border-[#666] transition-colors"
                                            />
                                        )}
                                    </div>
                                </div>
