...
export function EducationSection({ education }: EducationSectionProps) {
  return (
    <section id="education" className="py-20 px-6 sm:px-8 lg:px-16 relative bg-slate-900/50">
      <div className="absolute left-[20%] bottom-[20%] w-[400px] h-[400px] bg-orange-500/10 rounded-full blur-[120px]"></div>
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-2 text-slate-100 group-hover:text-orange-400 transition-colors">
                    {edu.degree}
                  </h3>
