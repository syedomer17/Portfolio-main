              ...
              >
                <div className="flex items-center gap-1.5 px-2 py-1 sm:px-3 sm:py-1.5 bg-transparent border border-[#333] rounded-[10px] hover:border-[#555] transition-colors">
                  <Icon
                    aria-hidden="true"
                    focusable="false"
                    className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#70717B] dark:text-[#D4D4D4] group-hover:text-[#424242] dark:group-hover:text-[#D4D4D4] transition-colors"
                  />
                  <span className="dark:group-hover:text-[#D4D4D4] dark:text-[#D4D4D4] font-instagram font-medium group-hover:text-[#424242] sm:text-[13px] text-[#70717B] text-[11px] transition-colors">
                    {skill.name}
                  </span>
                </div>
              </motion.div>
