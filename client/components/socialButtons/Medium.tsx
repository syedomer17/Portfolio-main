            ...
            <AnimatePresence>
                {showCard && (
                    <motion.div
                        ...
                        className="absolute bottom-full left-0 mb-2 w-80 bg-white dark:bg-[#1C1C1C] border border-slate-200 dark:border-[#2D2D2D] rounded-xl shadow-2xl z-20 overflow-hidden font-instagram"
