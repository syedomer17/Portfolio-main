            ...
            <AnimatePresence>
                {showCard && (
                    <motion.div
                        ...
                        className="absolute bottom-full left-0 mb-2 w-96 bg-white dark:bg-[#1C1C1C] border border-slate-200 dark:border-[#2D2D2D] rounded-xl shadow-2xl z-20 overflow-hidden font-instagram"
                        ...
                        <div className="p-4 pt-0">
                            ...
                            <div className="mb-3">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <svg className="w-4 h-4 text-blue-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
