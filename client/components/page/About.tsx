        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="rounded-xl border border-slate-200 dark:border-[#2A2A2A] bg-white dark:bg-[#0E0D09] p-4">
              ...
              <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-300" style={{ fontFamily: '"Instagram Sans", sans-serif' }}>
          ...
          <div className="mt-6">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-[#2A2A2A] bg-white dark:bg-[#0E0D09] p-4">
              <p className="text-sm text-slate-600 dark:text-slate-300" style={{ fontFamily: '"Instagram Sans", sans-serif' }}>
          ...
          <div className="mt-6">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-[#2A2A2A] bg-white dark:bg-[#0E0D09] p-4">
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-600 dark:text-slate-300" style={{ fontFamily: '"Instagram Sans", sans-serif' }}>
                <div>
